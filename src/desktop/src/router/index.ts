...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'tickets', name: 'Tickets', component: () => import('@web/views/TicketsPage.vue'), meta: { title: '问题反馈' } },
      { path: 'tickets/:id', name: 'TicketDetail', component: () => import('@web/views/TicketDetailPage.vue'), props: true, meta: { title: '工单详情' } },
